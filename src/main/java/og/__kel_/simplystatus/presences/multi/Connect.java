...
public class Connect {
    public Connect(DiscordRPC lib, MinecraftClient mc, Translate Translate, Long start_time, Config cfg){
        Client client = new Client();
        Assets assets = new Assets(HotKeys.bedrock, HotKeys.cringeIcons);
        DiscordRichPresence presence = new DiscordRichPresence();

        presence.details = Translate.replaceText(Translate.connect, true, false, false, client);
