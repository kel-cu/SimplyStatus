...
public class ConfigScreen {
    ...
    public static Screen buildScreen (Screen currentScreen) {
        ...
        mainCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.showTime")), HotKeys.showTime)
                ...
                .build());
        mainCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.voice")), HotKeys.cringeIcons)
                .setDefaultValue(false)
                .setSaveConsumer(newValue -> HotKeys.viewPlasmoVoice = newValue)
                .build());
        mainCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.cringe")), HotKeys.cringeIcons)
                .setDefaultValue(false)
...
//        addonsPresencesCategory = builder.getOrCreateCategory(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences")));
        // Hypixel Network
//        addonsPresencesCategory.addEntry(entryBuilder.startTextDescription(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences.hypixel"))).build());

//        addonsPresencesCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences.hypixel.enable")), false)
//                .setDefaultValue(false).build());
//        addonsPresencesCategory.addEntry(entryBuilder.startStrField(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences.hypixel.apiKey")), "")
//                .setDefaultValue("").build());
        // RevolutionWorlds, где API?
//        addonsPresencesCategory.addEntry(entryBuilder.startTextDescription(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences.reworlds"))).build());

//        addonsPresencesCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences.reworlds.enable")), false)
//                .setDefaultValue(false).build());
        //
        // Локализация
        //
