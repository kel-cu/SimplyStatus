...
public class ConfigScreen {
    ...
    public static Screen buildScreen (Screen currentScreen) {
        ...
        mainCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.showTime")), HotKeys.showTime)
                ...
                .build());
        mainCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.voice")), HotKeys.viewPlasmoVoice)
                .setDefaultValue(false)
...
//        entryBuilder
        ...
        addonsPresencesCategory.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("config.simplystatus.addonsPresences.soundcloud")), false)
