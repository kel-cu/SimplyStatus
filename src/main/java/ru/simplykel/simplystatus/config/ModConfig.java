...
public class ModConfig {
    ...
    public ModConfig() throws Exception {
        ...
        } else defaultAssets = new AssetsConfig(config.getJSONObject("assets").getJSONObject("default"));
        ...
        } else defaultUrlsAssets = new AssetsConfig(config.getJSONObject("assets").getJSONObject("~urls"));
