...
public class ReplayModConfigs {
    public ConfigCategory getCategory(ConfigBuilder builder){
        ConfigCategory category = builder.getOrCreateCategory(MutableText.of(new TranslatableTextContent("simplystatus.config.replaymod")));
        ConfigEntryBuilder entryBuilder = builder.entryBuilder();
        //
        category.addEntry(entryBuilder.startBooleanToggle(MutableText.of(new TranslatableTextContent("simplystatus.config.replaymod.view_replay_mod_server_name")), UserConfig.VIEW_REPLAY_MOD_SERVER_NAME)
                .setDefaultValue(false)
                .setSaveConsumer(newValue -> UserConfig.VIEW_REPLAY_MOD_SERVER_NAME = newValue)
                .build());
        category.addEntry(entryBuilder.startStrField(
                        MutableText.of(new TranslatableTextContent("simplystatus.config.localization.mod.replaymod")),
                ...
                .build());
        category.addEntry(entryBuilder.startStrField(
                        MutableText.of(new TranslatableTextContent("simplystatus.config.localization.mod.replaymod.state")),
                ...
                .build());
        category.addEntry(entryBuilder.startStrField(
                        MutableText.of(new TranslatableTextContent("simplystatus.config.localization.mod.replaymod.date_format")),
