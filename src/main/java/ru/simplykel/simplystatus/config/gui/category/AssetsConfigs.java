...
public class AssetsConfigs {
    public ConfigCategory getCategory(ConfigBuilder builder){
        ConfigCategory category = builder.getOrCreateCategory(Text.translatable("simplystatus.config.assets"));
        ConfigEntryBuilder entryBuilder = builder.entryBuilder();
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.logo"),
                        Client.ASSETS.logo)
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.day"),
                        Client.ASSETS.day)
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.night"),
                        Client.ASSETS.night)
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                Text.translatable("simplystatus.config.assets.morning"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.evening"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.world"),
                        Client.ASSETS.world)
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.world_nether"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.world_the_end"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.music"),
                        Client.ASSETS.music)
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.replaymod"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.voice"),
                        Client.ASSETS.voice)
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.unknown"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                                Text.translatable("simplystatus.config.assets.unknown_world"),
