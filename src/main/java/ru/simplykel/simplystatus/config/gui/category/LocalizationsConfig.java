...
public class LocalizationsConfig {
    public ConfigCategory getCategory(ConfigBuilder builder){
        ConfigCategory category = builder.getOrCreateCategory(Text.translatable("simplystatus.config.localization"));
        ConfigEntryBuilder entryBuilder = builder.entryBuilder();
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.mainmenu"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.mainmenu.state"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.death.one"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.death.two"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.death.three"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.item.air"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.item"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.item.count"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.item.count.stack"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.unknown.server"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.unknown.world"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.unknown"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.address.hidden"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.address"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.time.day"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.time.night"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.time.morning"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.time.evening"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.world.overworld"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.world.nether"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.world.the_end"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.singleplayer"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.player.sleep"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.player.sneak"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.player.on.fire"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.player.on.water"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.player.statistics"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.server.connecting"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.server.disconnected"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.world.loading"),
        ...
        //
        category.addEntry(entryBuilder.startStrField(
                        Text.translatable("simplystatus.config.localization.player.world.state"),
