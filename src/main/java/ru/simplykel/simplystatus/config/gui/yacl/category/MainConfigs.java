...
public class MainConfigs {
    public ConfigCategory getCategory(){
        ...
        category.option(Option.createBuilder(boolean.class)
                .description(OptionDescription.createBuilder().text(Localization.toText("A reboot will be required to apply the changes to ModMenu")).build())
                .name(Localization.toText("Use YACL"))
