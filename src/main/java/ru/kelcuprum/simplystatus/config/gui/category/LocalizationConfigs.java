...
public class LocalizationConfigs {
    public ConfigCategory getCategory(){
        ...
        category.group(OptionGroup.createBuilder()
                ...
                .option(
                        Option.createBuilder(String.class)
                                .name(Localization.getText("simplystatus.config.localization.item"))
                                .binding(Localization.getLcnDefault("item"),
                                        () -> Localization.getLocalization("item", false),
                                        newVal -> Localization.setLocalization("item", newVal))
                                .controller(StringControllerBuilderImpl::new)
                                .build()
                ).option(
                        Option.createBuilder(String.class)
                                .name(Localization.getText("simplystatus.config.localization.item.count"))
                                .binding(Localization.getLcnDefault("item.count"),
                                        () -> Localization.getLocalization("item.count", false),
                                        newVal -> Localization.setLocalization("item.count", newVal))
                                .controller(StringControllerBuilderImpl::new)
                                .build()
                ).option(
                        Option.createBuilder(String.class)
        ...
        category.group(OptionGroup.createBuilder()
                ...
                .option(
                        ...
                        Option.createBuilder(String.class)
                                ...
                                .controller(StringControllerBuilderImpl::new)
                                .available(CLIENT.getLaunchedVersion().equals("23w13a_or_b"))
                                .build()
                ).build());
