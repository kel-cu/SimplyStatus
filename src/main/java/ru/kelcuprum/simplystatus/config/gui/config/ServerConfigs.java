...
public class ServerConfigs extends Screen {
    ...
    private VanillaButtonBoolean showCustomName;
    private EditBoxString customName;
    private VanillaButtonBoolean showName;
    private VanillaButtonBoolean showAddress;
    private VanillaButtonBoolean showIcon;
    ...
    private void initCategory(){
        ...
        this.showCustomName = new VanillaButtonBoolean(140, 40, x, 20, SimplyStatus.serverConfig, "USE_CUSTOM_NAME", false, Component.translatable("simplystatus.config.server.show_custom_name"));
        ...
        this.customName.setContent(SimplyStatus.serverConfig.getString("CUSTOM_NAME", ""));
        this.customName.setResponse(s -> SimplyStatus.serverConfig.setString("CUSTOM_NAME", s));
        addRenderableWidget(customName);
        //
        this.showName = new VanillaButtonBoolean(140, 90, x, 20, SimplyStatus.serverConfig, "SHOW_NAME", true, Component.translatable("simplystatus.config.server.show_name"));
        addRenderableWidget(showName);
        this.showAddress = new VanillaButtonBoolean(140, 115, x, 20, SimplyStatus.serverConfig, "SHOW_ADDRESS", false, Component.translatable("simplystatus.config.server.show_address"));
        addRenderableWidget(showAddress);
        this.showIcon = new VanillaButtonBoolean(140, 140, x, 20, SimplyStatus.serverConfig, "SHOW_ICON", false, Component.translatable("simplystatus.config.server.show_icon"));
        ...
        this.iconUrl.setContent(SimplyStatus.serverConfig.getString("ICON_URL", "https://api.mcstatus.io/v2/icon/%address%"));
        this.iconUrl.setResponse(s -> SimplyStatus.serverConfig.setString("ICON_URL", s));
