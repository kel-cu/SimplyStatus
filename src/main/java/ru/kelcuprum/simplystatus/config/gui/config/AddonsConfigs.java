...
public class AddonsConfigs extends Screen {
    ...
    public void tick() {
        ...
        //
        this.titleMods.setY(40 - scrolled);
        this.enableReplay.setY(65 - scrolled);
        this.enableVoice.setY(90 - scrolled);
        this.enableMusic.setY(115 - scrolled);
        //
        this.titleIndicators.setY(140 - scrolled);
        this.showItems.setY(165 - scrolled);
        this.enableTimeCycle.setY(190 - scrolled);
        this.enableWorld.setY(215 - scrolled);
        //
        this.titleCustom.setY(240 - scrolled);
        this.useCustomAssets.setY(265 - scrolled);
        this.useCustomAppID.setY(290 - scrolled);
        this.customAppID.setY(315 - scrolled);
    }
    private void initCategory(){
        ...
        this.enableReplay = new ButtonBoolean(140, 65, x, 20, SimplyStatus.userConfig, "VIEW_REPLAY_MOD", true, Component.translatable("simplystatus.config.addons.view_replay_mod"));
        addRenderableWidget(this.enableReplay).setActive(SimplyStatus.replayMod);
        this.enableVoice = new ButtonBoolean(140, 90, x, 20, SimplyStatus.userConfig, "VIEW_VOICE_SPEAK", true, Component.translatable("simplystatus.config.addons.view_voice_speak"));
        addRenderableWidget(this.enableVoice).setActive(SimplyStatus.isVoiceModsEnable);
        this.enableMusic = new ButtonBoolean(140, 115, x, 20, SimplyStatus.userConfig, "VIEW_MUSIC_LISTENER", true, Component.translatable("simplystatus.config.addons.view_music_listener"));
        ...
        this.showItems = new ButtonBoolean(140, 165, x, 20, SimplyStatus.userConfig, "SHOW_ITEMS", true, Component.translatable("simplystatus.config.addons.show_items"));
        addRenderableWidget(this.showItems);
        this.enableTimeCycle = new ButtonBoolean(140, 190, x, 20, SimplyStatus.userConfig, "ENABLE_TIME_CYCLE", true, Component.translatable("simplystatus.config.addons.enable_time_cycle"));
        addRenderableWidget(this.enableTimeCycle);
        this.enableWorld = new ButtonBoolean(140, 215, x, 20, SimplyStatus.userConfig, "ENABLE_WORLD", true, Component.translatable("simplystatus.config.addons.enable_world"));
        ...
        this.useCustomAssets = new ButtonBoolean(140, 265, x, 20, SimplyStatus.userConfig, "USE_CUSTOM_ASSETS", false, Component.translatable("simplystatus.config.addons.use_custom_assets"));
        addRenderableWidget(this.useCustomAssets);
        this.useCustomAppID = new ButtonBoolean(140, 290, x, 20, SimplyStatus.userConfig, "USE_CUSTOM_APP_ID", false, Component.translatable("simplystatus.config.client.use_custom_app_id"));
        ...
        this.customAppID.setValue(SimplyStatus.userConfig.getString("CUSTOM_APP_ID", ModConfig.baseID));
        this.customAppID.setResponder(s -> SimplyStatus.userConfig.getString("CUSTOM_APP_ID", s));
